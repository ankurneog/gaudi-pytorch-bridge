...
mul_Tensor_1 = CallFunction(aten.mul.Tensor, _to_copy_default, Ignored())
mul_Tensor_2 = CallFunction(aten.mul.Tensor, view_default_7, mul_Tensor_1)
_softmax_backward_data_default = CallFunction(
    aten._softmax_backward_data.default, mul_Tensor_2, _softmax_default, Ignored(), Ignored()
)
mul_Tensor_3 = CallFunction(aten.mul.Tensor, _softmax_backward_data_default, KeywordArg("scale_factor"))
