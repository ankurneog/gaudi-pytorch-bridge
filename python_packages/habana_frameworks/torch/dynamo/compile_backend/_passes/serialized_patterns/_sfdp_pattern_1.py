...
div_Tensor_1 = CallFunction(aten.div.Tensor, _softmax_backward_data_default, KeywordArg("inv_scale"))
...
_sfdp_pattern_1_training = MultiOutputPattern([view_default_5, view_default_9, transpose_int_4, view_default_11, None])
