...
struct Unique2Eager : OpBackend {
  Unique2Eager(int device_id, c10::ScalarType scalar_type);
  void AddNode(synapse_helpers::graph&, const at::Stack&) override;
};

OutputMetaDataVector UniqueMeta(const at::Stack& stack) {
